...
if do_atmosphere_plots:
  ...
  fig_names += ['sec:Land surface']
#pplcc_tree_fract_box, pplcc_shrub_fract_box, pplcc_grass_fract_box, pplcc_baresoil_fract_box, pplcc_C3pft_fract_box und pplcc_C4pft_fract_box
  fig_names += ['lnd_pplcc_tree_fract_box','lnd_pplcc_shrub_fract_box', 'lnd_pplcc_grass_fract_box', 'lnd_pplcc_baresoil_fract_box']
  fig_names += ['lnd_pplcc_C3pft_fract_box','lnd_pplcc_C4pft_fract_box']
...
#fig_names += ['tke30w', 'iwe30w', 'kv30w']
  ...
  if not do_conf_dwd:
     ...
     vclw     = 'clw'
     vcli     = 'cli'
     vpplcc_tree_fract_box = 'pplcc_tree_fract_box'
     vpplcc_shrub_fract_box = 'pplcc_shrub_fract_box'
     vpplcc_grass_fract_box = 'pplcc_grass_fract_box'
     vpplcc_baresoil_fract_box = 'pplcc_baresoil_fract_box'
     vpplcc_C3pft_fract_box = 'pplcc_C3pft_fract_box'
     vpplcc_C4pft_fract_box = 'pplcc_C4pft_fract_box'
  else:
     vpfull   = 'pres'
     vtas     = 't_2m'
     vts      = 't_s'
...
if do_atmosphere_plots and not iopts.no_plots:
  ...
  fname_lnd_2d = '%s%s_%s.nc' % (run, lnd_2d, tstep)
  print('Dataset %s' % (fname_lnd_2d))
  IcD_lnd2d = pyic.IconData(
                 fname        = fname_lnd_2d,
                 path_data    = path_data,
                 path_grid    = path_grid_atm,
                 path_ckdtree = path_ckdtree_atm,
...
#pplcc_tree_fract_box, pplcc_shrub_fract_box, pplcc_grass_fract_box, pplcc_baresoil_fract_box, pplcc_C3pft_fract_box und pplcc_C4pft_fract_box
    ...
    if not do_conf_dwd:
      fig_name = 'lnd_pplcc_tree_fract_box'
      if fig_name in fig_names:
        FigInf = pyicqp.qp_hplot(fpath=path_data+fname, var=vpplcc_tree_fract_box, it=0,
                               t1=t1, t2=t2,
                               var_add=0.0,
                               units = 'frac',
                               clim=[0.,1.], cincr=0.05, cmap='cmo.speed',
                               land_facecolor='none',
                               IcD=IcD_lnd2d,
                               save_data=save_data, fpath_nc=path_nc+fig_name+'.nc',
                               **Ddict_global)
        save_fig('lnd_pplcc_tree_fract_box', path_pics, fig_name, FigInf)


      fig_name = 'lnd_pplcc_shrub_fract_box'
      if fig_name in fig_names:
        FigInf = pyicqp.qp_hplot(fpath=path_data+fname, var=vpplcc_shrub_fract_box, it=0,
                               t1=t1, t2=t2,
                               var_add=0.0,
                               units = 'frac',
                               clim=[0.,1.], cincr=0.05, cmap='cmo.speed',
                               ...
                               save_data=save_data, fpath_nc=path_nc+fig_name+'.nc',
                               **Ddict_global)
        save_fig('lnd_pplcc_shrub_fract_box', path_pics, fig_name, FigInf)

      fig_name = 'lnd_pplcc_grass_fract_box'
      if fig_name in fig_names:
        FigInf = pyicqp.qp_hplot(fpath=path_data+fname, var=vpplcc_grass_fract_box, it=0,
                               t1=t1, t2=t2,
                               var_add=0.0,
                               units = 'frac',
                               clim=[0.,1.], cincr=0.05, cmap='cmo.speed',
                               ...
                               save_data=save_data, fpath_nc=path_nc+fig_name+'.nc',
                               **Ddict_global)
        save_fig('lnd_pplcc_grass_fract_box', path_pics, fig_name, FigInf)


      fig_name = 'lnd_pplcc_baresoil_fract_box'
      if fig_name in fig_names:
        FigInf = pyicqp.qp_hplot(fpath=path_data+fname, var=vpplcc_baresoil_fract_box, it=0,
                               t1=t1, t2=t2,
                               var_add=0.0,
                               units = 'frac',
                               clim=[0.,1.], cincr=0.05, cmap='cmo.matter',
                               land_facecolor='none',
                               IcD=IcD_lnd2d,
                               save_data=save_data, fpath_nc=path_nc+fig_name+'.nc',
                               **Ddict_global)
        save_fig('lnd_pplcc_baresoil_fract_box', path_pics, fig_name, FigInf)

        
      fig_name = 'lnd_pplcc_C3pft_fract_box'
      if fig_name in fig_names:
        FigInf = pyicqp.qp_hplot(fpath=path_data+fname, var=vpplcc_C3pft_fract_box, it=0,
                               t1=t1, t2=t2,
                               var_add=0.0,
                               units = 'frac',
                               clim=[0.,1.], cincr=0.05, cmap='cmo.speed',
                               ...
                               save_data=save_data, fpath_nc=path_nc+fig_name+'.nc',
                               **Ddict_global)
        save_fig('lnd_pplcc_C3pft_fract_box', path_pics, fig_name, FigInf)

        # ---

      fig_name = 'lnd_pplcc_C4pft_fract_box'
      if fig_name in fig_names:
        FigInf = pyicqp.qp_hplot(fpath=path_data+fname, var=vpplcc_C4pft_fract_box, it=0,
                               t1=t1, t2=t2,
                               var_add=0.0,
                               units = 'frac',
                               clim=[0.,1.], cincr=0.05, cmap='cmo.speed',
                               ...
                               save_data=save_data, fpath_nc=path_nc+fig_name+'.nc',
                               **Ddict_global)
        save_fig('lnd_pplcc_C4pft_fract_box', path_pics, fig_name, FigInf)
